# PROMPT EKSEKUSI: Inisialisasi Git, Polish README & Push ke GitHub

Copy dan paste seluruh isi prompt di bawah ini ke **Antigravity IDE** untuk mengeksekusi proses inisialisasi Git, pembaruan `README.md`, dan push ke remote repository GitHub:

---

```markdown
# Role & Objective
Kamu adalah AI Coding Assistant di Antigravity IDE. Tugasmu adalah menyiapkan repository Git lokal untuk proyek **StackUp** (Flutter), memperbarui berkas `README.md` menjadi dokumentasi publik yang profesional, lalu melakukan commit dan push seluruh kode sumber ke GitHub di repository `https://github.com/rexkarbu/stackup-flutter`.

---

## 1. PEMBARUAN DOKUMENTASI (`README.md`)

Perbarui file `README.md` di root proyek agar informatif, modern, dan profesional untuk portofolio GitHub. Tuliskan konten berikut ke `README.md`:
...
Pastikan berkas `.gitignore` sudah mencakup:
- `/build/`
- `.dart_tool/`
- `*.iml`
- `.idea/`
...
# 2. Tambahkan semua file yang tidak diabaikan oleh .gitignore
git add .

# 3. Commit seluruh perubahan
git commit -m "feat: initial release of StackUp MVP - Game Backlog & Priority Tracker"

# 4. Set nama branch utama ke 'main'
git branch -M main

# 5. Pasang remote URL
git remote add origin https://github.com/rexkarbu/stackup-flutter.git

# 6. Push ke GitHub
# Catatan: Jika repo di GitHub sudah memiliki commit awal (misal file README/license dari GitHub UI),
# gunakan rebase terlebih dahulu sebelum push:
git pull origin main --rebase --allow-unrelated-histories
git push -u origin main
```

Pastikan proses push berhasil tanpa error dan verifikasi bahwa repository di `https://github.com/rexkarbu/stackup-flutter` sudah memuat seluruh kode dan tampilan README yang baru.
```
